            ...
            <div className={styles.statsContainer}>
              <div className={styles.statCard}>
                ...
                <div className={styles.statCardValue}>
                  {dashboardData ? dashboardData.scanStats.total.toLocaleString() : "Loading..."}
                </div>
                <div className={`${styles.statCardChange} ${styles.positiveChange}`}>
                  <i className="fas fa-arrow-up"></i> Processed scans
                </div>
              </div>
              ...
              <div className={styles.statCard}>
                ...
                <div className={styles.statCardValue}>
                  {dashboardData ? dashboardData.userStats.total.toLocaleString() : "Loading..."}
                </div>
                <div className={`${styles.statCardChange} ${styles.positiveChange}`}>
                  <i className="fas fa-arrow-up"></i> Registered users
                </div>
              </div>

              <div className={styles.statCard}>
                <div className={styles.statCardHeader}>
                  <div className={styles.statCardTitle}>Appointments</div>
                  <div className={styles.statCardIcon}>
                    <i className="fas fa-calendar-day"></i>
                  </div>
                </div>
                <div className={styles.statCardValue}>
                  {dashboardData ? dashboardData.appointmentStats.total.toLocaleString() : "Loading..."}
                </div>
                <div className={`${styles.statCardChange} ${styles.positiveChange}`}>
                  <i className="fas fa-arrow-up"></i> Total appointments
                </div>
              </div>

              <div className={styles.statCard}>
                <div className={styles.statCardHeader}>
                  <div className={styles.statCardTitle}>Premium Users</div>
                  <div className={styles.statCardIcon}>
                    <i className="fas fa-crown"></i>
                  </div>
                </div>
                <div className={styles.statCardValue}>
                  {dashboardData ? dashboardData.userStats.premium.toLocaleString() : "Loading..."}
                </div>
                <div className={`${styles.statCardChange} ${styles.positiveChange}`}>
                  <i className="fas fa-arrow-up"></i> Premium subscribers
                </div>
              </div>
            </div>
