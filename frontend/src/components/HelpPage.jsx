    ...
    <div className="help-page">
      <header>
        <nav className="navbar">
          <div className="logo">E-med</div>
          <ul className="nav-links">
            <li><Link to="/LandingPage">Home</Link></li>
            <li><Link to="/ScanPage">Scan</Link></li>
            <li><Link to="/About">About</Link></li>
            <li><Link to="/HelpPage">Help & Support</Link></li>
          </ul>
          <div className="nav-buttons">
            <button className="login-btn">Log in</button>
            <button className="signup-btn">Sign up</button>
            <span className="settings-icon" onClick={toggleSidebar}>
              <FontAwesomeIcon icon={faBars} style={{ color: "#1e57b8" }} />
            </span>
          </div>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="copyright">
              <p>&copy; {new Date().getFullYear()} SCANAI. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
